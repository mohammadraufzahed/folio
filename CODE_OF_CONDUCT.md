...
Our standards for behavior are:

- **Respect**: Treat everyone with respect and consideration
- **Inclusion**: Be inclusive and welcoming to all contributors
- **Collaboration**: Work together constructively and professionally
- **Focus**: Focus on what is best for the community
...
Project maintainers have the right and responsibility to remove, edit, or reject comments, commits, code, wiki edits, issues, and other contributions that are not aligned with this Code of Conduct, and to communicate the reasons for moderation decisions when appropriate.
...
If you experience or witness unacceptable behavior, please report it to the project maintainers by emailing: conduct@folio-pdf.dev
